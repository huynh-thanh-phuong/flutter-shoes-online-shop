...
import 'package:flutter_online_shop/views/shared/custom_pacer.dart';
            ...
            SizedBox(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children:const [
                      CategoryBtn(lable: "Men", buttonClr: Colors.black,),
                      CategoryBtn(lable: "Women", buttonClr: Colors.grey,),
                      CategoryBtn(lable: "Men", buttonClr: Colors.grey,),
                    ],
                  ),
                  const CustomSpacer(),
                  ...
                  Row(
                    children: const[
                      CategoryBtn(lable: "Shoes", buttonClr: Colors.black,),
                      CategoryBtn(lable: "Apparrels", buttonClr: Colors.grey,),
                      CategoryBtn(lable: "Accessories", buttonClr: Colors.grey,),
                    ],
                  ),
                  const CustomSpacer(),
